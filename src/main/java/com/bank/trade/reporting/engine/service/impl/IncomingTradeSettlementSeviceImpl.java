...
public class IncomingTradeSettlementSeviceImpl implements TradeReportService {

	@Override
	public Map<Object, Double> generateTradeReport(List<Trade> tradeList) {
		Map<Object, Double> result = tradeList.stream().filter(trade -> isTradeTypeMatched(trade, BuySellEnum.SELL))
