...
public class IncomingTradeSettlementSeviceImplTest {

	@Test
	public void test_generateTradeReport() {
		List<Trade> tradeList = new ArrayList<>();

		tradeList.add(TradeDataUtils.getTradeInfo("bar", BuySellEnum.SELL, 0.50, "AED",
		...
		tradeList.add(TradeDataUtils.getTradeInfo("foo", BuySellEnum.BUY, 0.40, "GBP",
				LocalDate.of(2018, Month.JANUARY, 1), LocalDate.of(2018, Month.JANUARY, 3), 100, 150.5));
		tradeList.add(TradeDataUtils.getTradeInfo("foo", BuySellEnum.SELL, 0.32, "USD",
		...
		Map<Object, Double> result = TradeReportServiceFactory
				.getTradeReportService(ReportType.INCOMING_TRADE_SETTLEMENT_REPORT).generateTradeReport(tradeList);
