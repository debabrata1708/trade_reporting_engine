...
public class OutgoingTradeRankingServiceImplTest {
	...
	public void test_generateTradeReport() {
		...
		tradeList.add(TradeDataUtils.getTradeInfo(TRADE_NAME_FOO, BuySellEnum.SELL, 0.40, "GBP",
				LocalDate.of(2018, Month.JANUARY, 1), LocalDate.of(2018, Month.JANUARY, 3), 100, 150.5));
		tradeList.add(TradeDataUtils.getTradeInfo(TRADE_NAME_FOO, BuySellEnum.BUY, 0.32, "USD",
				LocalDate.of(2018, Month.JANUARY, 1), LocalDate.of(2018, Month.JANUARY, 3), 150, 70.20));
		tradeList.add(TradeDataUtils.getTradeInfo(TRADE_NAME_BAR, BuySellEnum.BUY, 0.50, "AED",
				LocalDate.of(2018, Month.JANUARY, 1), LocalDate.of(2018, Month.JANUARY, 2), 118, 220.25));
		tradeList.add(TradeDataUtils.getTradeInfo(TRADE_NAME_BAR, BuySellEnum.BUY, 0.44, "SGP",
		...
		Map<Object, Double> result = TradeReportServiceFactory
				.getTradeReportService(ReportType.OUTGOING_TRADE_RANKING_REPORT).generateTradeReport(tradeList);
